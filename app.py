...
def predict():
    ...
    if request.method == 'POST':
       ...
       Commision = float(request.form['Commision'])
       Net_Sales = float(request.form['Net_Sales'])
       Dest_fe = request.form['Destination']
       Product_Name = request.form['Product_Name']
       Distribution = request.form['Distribution_Channel']
       Duration = int(request.form['Duration'])
       Agency_fe = request.form['Agency']
       Total_Sale = float(request.form['Total_Sale'])
       ...
       Agency_fcode = agency_mapping.get(Agency_fe)
       Product_fcode = product_name.get(Product_Name)
       Destination_fcode = destination.get(Dest_fe)

       prediction = model.predict([[Duration, Net_Sales, Commision, Age, Destination_fcode, Agency_fcode, Product_fcode, Agency_Type_Travel, Distribution, Total_Sale]])
